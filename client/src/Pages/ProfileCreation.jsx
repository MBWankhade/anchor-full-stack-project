...
const ProfileCreation = () => {
  ...
  const [educationDetailsAdded, setEducationDetailsAdded] = useState(false);

  const handleAddEducationDetails = () => {
    setEducationDetailsAdded(true);
  };

  const handleFormSubmit = async () => {
    try {
      const backendEndpoint = "https://anchor-full-stack-project.onrender.com/new-profile";
      formData['coinsEarned'] = coinsEarned;
      const newformData = new FormData();
      newformData.append('profileData', JSON.stringify(formData));
      newformData.append('resumePdf', resumePdf);
  ...
  return (
    <div className="p-8 bg-white text-primary">
      ...
      <div className="mb-8">
        ...
        {!educationDetailsAdded && (
          <div className="mb-4">
            <button
              className="bg-green text-primary py-2 px-4 rounded"
